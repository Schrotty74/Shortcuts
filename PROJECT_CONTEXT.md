...
The first published shortcut is `Weather for City` version `1.2`.
...
- `Weather for City` version `1.2` published.
...
- Version `1.2` adds a start menu and a GitHub latest-release update check.
...
- GitHub Release `v1.2` created with ZIP, direct shortcut asset, and SHA-256
  file.
...
- GitHub Release `v1.2` remains the weather shortcut release even when the
